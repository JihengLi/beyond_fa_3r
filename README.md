...
```bash
DOCKER_BUILDKIT=1 sudo docker build -t beyond_fa_3r:v0.0.1 .
```
...
output_dir="/home-local/lij112/codes/beyond_fa_challenge/results/Outputs-3r"

mkdir -p $output_dir
sudo chmod 777 $output_dir

DOCKER_NOOP_VOLUME="beyond_fa_3r-volume"
